...
describe('Dog Datbase', () => {
    ...
    beforeAll(async() => {
        ...
        const arrayOfDog = [
            ({name: "Bob",breed: "pug",age: "Young", location: "San Francisco",image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxSJiFgnYNscgb9g3uGXcQfpfnJ8XhPMF-Gw&usqp=CAU",description: "Bob is a pug who loves to play fetch and is a good",gender: "Male", size: "Medium", status: "Not Available"}),
            ({
                name: "Rocky",
                breed: "chihuahua",
                age: "senior",
...
// testing Dog, models
    test('can create dogs', async () => {
        ...
        expect(testDog.image).toBe("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxSJiFgnYNscgb9g3uGXcQfpfnJ8XhPMF-Gw&usqp=CAU")
        expect(testDog.description).toBe("Bob is a pug who loves to play fetch and is a good")
